    ...
    <table class="table table-hover">
        ...
        <tr>
            <td><g:message code="auditlog.search.ssn"
                           default="CPR Nummer" /></td>
            <td colspan="5">
                <g:textField name="ssn" value="${ssn}"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td><g:message code="auditlog.search.from.date"
                           default="Fra dato" /> </td><td colspan="2">
            <g:datePicker value="${viewFromDate}" name="fromDate"/>
            <td><g:message code="auditlog.search.to.date"
                           default="Til dato"/></td><td colspan="2">
            <g:datePicker value="${toDate}" name="toDate"/>
        </td>
        </tr>
        <tr>
            <td><g:message code="auditlog.search.exceptionOccurred"
                           default="Fejl?" /> </td><td colspan="5">
            <g:checkBox name="exceptionOccurred" value="${exceptionOccurred}"/>
        </td>
        </tr>
        ...
        <tr>
            <td align="left" colspan="6">
                <g:actionSubmit class="btn btn-primary"
                                action="search"
                                value="${message(code:"patient.overview.form.submit", default:"Søg") }"/>
            </td>
        </tr>
        </tbody>
